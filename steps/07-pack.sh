...
CFG=${PDFium_CONFIGURATION:-Release}
...
cp "$PACKAGING/pdfium-binaries.props" "$STAGING_RES/$ARTIFACT_NAME.props" 

YEAR=$(date +%Y)
export ARTIFACT_NAME ARTIFACT_NAME VERSION STAGING_BIN STAGING_RES PACKAGING YEAR
